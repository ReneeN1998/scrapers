...
with open ('testlinks10.csv') as urls:
    for url in urls:
        ...
        try: 
            number_alltime_reviews = driver.find_element_by_xpath('.//*[@id="userReviews"]/div[2]/div[2]/span[2]').text
        except: 
        ...
        try:
            ...
            update_count2 = ''
        #link3 = driver.find_element_by_xpath('//*[@id="appDetailsUnderlinedLinks"]/div/div/div[2]/a[3]')
        #link3.click()
        #driver = webdriver.Chrome()
        #update_count2 = len(driver.find.elements_by_css_selector('div.eventcalendar_LazyCalendarSectionCtn_1_BP6'))
        ...
        url = {'title': title, 'price1': price1, 'price2': price2, 'discountprice':discountprice,
                ...
                'tags': tags, 'update_count': update_count, 'update_count2': update_count2,# 'update_count': update_count
                }
        url_list.append(url)
        driver.close()
